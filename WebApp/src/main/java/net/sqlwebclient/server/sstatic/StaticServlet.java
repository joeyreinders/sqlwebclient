package net.sqlwebclient.server.sstatic;
...
public final class StaticServlet extends HttpServlet {
    private static final long serialVersionUID = -4699106425426623308L;
    private static final Log logger = LogFactory.getLog(StaticServlet.class);

    public StaticServlet() {
        logger.info("Static Servlet constructor called");
    }
    ...
    protected String getPath(HttpServletRequest req) {
        ...
        if("/".equals(pathInfo) || (pathInfo == null || pathInfo.isEmpty())) {
            pathInfo = "/pages/index.html";
        }
